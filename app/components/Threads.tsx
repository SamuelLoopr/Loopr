...
export interface ThreadsProps {
  /** Line colour as normalised RGB, e.g. #A855F7 -> [0.659, 0.333, 0.969]. */
...
export default function Threads({
  ...
  useEffect(() => {
    ...
    // Bound to a non-null local so the hoisted resize/mouse handlers below keep
    // the narrowed type (TS won't narrow a possibly-null capture inside them).
